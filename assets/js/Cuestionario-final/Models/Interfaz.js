export class Interfaz {
    ...
    muestraCalificacion(calificacion){
        if(calificacion < 80){
            ...
            <form action="https://formsubmit.co/f7408976028a4896b58ee04e766b9f14" 
            method="POST" class="border py-5 px-3 d-flex flex-column justify-content-around gap-2">
                ...
                <input class="form-control shadow-none" type="tel" name="folio" required placeholder="Escribe aquí tu folio o referencia" pattern="[0-9]{7}" title="Tu numero de folio empieza con 3 o 4 y solo esta compuesto por 7 dígitos">
                
                <label class="form-label">Nombre completo del titular del contrato:</label>
                <input class="form-control shadow-none" type="text" name="nombreTitular" required placeholder="Escribe aquí el nombre completo" pattern="[A-Za-z ]{1,50}" title="El nombre solo debe tener letras">
                
                <label class="form-label">Nombre completo del estudiante:</label>
                <input class="form-control shadow-none" type="text" name="nombreEstudiante" required placeholder="Escribe aquí tu nombre completo" pattern="[A-Za-z ]{1,50}" title="El nombre solo debe tener letras">
                
                <label class="form-label">Edad: (solo número):</label>
                <input class="form-control shadow-none" type="tel" name="edad" required placeholder="Escribe aquí tu edad" pattern="[0-9]{2}" title="La edad solo puede tener números">

                <label class="form-label">Correo electrónico:</label>
                <input class="form-control shadow-none" type="email" name="email" required placeholder="Escribe aquí tu correo" title="Verifica bien tu correo">
                

                <hr>
                <p class="text-center display-5 text-primary"><strong>Domicilio donde quieres recibir tu diploma</strong>.</p>
                <label class="form-label">Calle:</label>
                <input class="form-control shadow-none" type="text" name="calle" required placeholder="Escribe aquí tu calle" pattern="[A-Za-z0-9 ]{1,40}">
                
                <label class="form-label">Número de Exterior:</label>
                <input class="form-control shadow-none" type="text" name="numeroExterior" required placeholder="Escribe aquí tu número de exterior" pattern="[A-Za-z0-9 ]{1,20}">
                
                <label class="form-label">Número de interior:</label>
                <input class="form-control shadow-none" type="text" name="numeroInterior" placeholder="Escribe aquí tu número de interior" pattern="[A-Za-z0-9 ]{1,20}">
                
                <label class="form-label">Entre calles:</label>
                <input class="form-control shadow-none" type="text" name="entreCalle" required placeholder="Escribe aquí las entre calles" pattern="[A-Za-z0-9 ]{1,45}">
                
                <label class="form-label">Referencias (color y tipo de fachada):</label>
                <input class="form-control shadow-none" type="text" name="referencias" required placeholder="Escribe aquí la referencia de tu domicilio" pattern="[A-Za-z0-9 ]{1,75}">
                
                <label class="form-label">Colonia:</label>
                <input class="form-control shadow-none" type="text" name="colonia" required placeholder="Escribe aquí tu colonia"pattern="[A-Za-z0-9 ]{1,45}">
                
                <label class="form-label">Delegación o Municipio:</label>
                <input class="form-control shadow-none" type="text" name="delegacion" required placeholder="Escribe aquí tu delegación o Municipio" pattern="[A-Za-z0-9 ]{1,45}">
                
                <label class="form-label">Estado:</label>
                <input class="form-control shadow-none" type="text" name="estado" required placeholder="Escribe aquí tu estado" pattern="[A-Za-z ]{1,45}" title="El estado solo debe tener letras">
                
                <label class="form-label">Código Postal:</label>
                <input class="form-control shadow-none" type="tel" name="codigoPostal" required placeholder="Escribe aquí tu código postal" pattern="[0-9]{5}" title="El codigo postal debe componerse de 5 números ">
                
                <label class="form-label">Teléfono de casa:</label>
                <input class="form-control shadow-none" type="tel" name="telefonoCasa" required placeholder="Escribe aquí tu teléfono de casa" pattern="[0-9]{10}" title="El numero de casa debe ser a 10 dígitos">
                
                <label class="form-label">Celular:</label>
                <input class="form-control shadow-none" type="tel" name="telefonoCelular" required placeholder="Escribe aquí tu celular" pattern="[0-9]{10}" title="El numero de casa debe ser a 10 dígitos">
                <hr>
