...
//imágenes de temas
const imgTema1 = "./assets/img/cuestionario/imagen_tema 1.png";
const imgTema2 = "./assets/img/cuestionario/imagen_tema 2.png";
const imgTema3 = "./assets/img/cuestionario/imagen_tema 3.png";
const imgTema4 = "./assets/img/cuestionario/imagen_tema 4.png";
const imgTema5 = "./assets/img/cuestionario/imagen_tema 5.png";
const imgTema6 = "./assets/img/cuestionario/imagen_tema 6.png";
const imgTema7_1 = "./assets/img/cuestionario/imagen_tema 7_1.png";
const imgTema7_2 = "./assets/img/cuestionario/imagen_tema 7_2.png";
const imgTema7_3 = "./assets/img/cuestionario/imagen_tema 7_3.png";
const imgTema8 = "./assets/img/cuestionario/imagen_tema 8.png";
const imgTema9 = "./assets/img/cuestionario/imagen_tema 9.png";
const imgTema10 = "./assets/img/cuestionario/imagen_tema 10.png";
const imgTema11 = "./assets/img/cuestionario/imagen_tema 11.png";
const imgTema12 = "./assets/img/cuestionario/imagen_tema 12.png";
const imgTema13_1 = "./assets/img/cuestionario/imagen_tema 13_1.png";
const imgTema13_2 = "./assets/img/cuestionario/imagen_tema 13_2.png";
const imgTema13_3 = "./assets/img/cuestionario/imagen_tema 13_3.png";
const imgTema13_4 = "./assets/img/cuestionario/imagen_tema 13_4.png";
const imgTema14 = "./assets/img/cuestionario/imagen_tema 14.png";
const imgTema15 = "./assets/img/cuestionario/imagen_tema 15.png";
const imgTema16 = "./assets/img/cuestionario/imagen_tema 16.png";
const imgTema17 = "./assets/img/cuestionario/imagen_tema 17.png";
const imgTema18 = "./assets/img/cuestionario/imagen_tema 18.png";
const imgTema19 = "./assets/img/cuestionario/imagen_tema 19.png";
const imgTema20 = "./assets/img/cuestionario/imagen_tema 20.png";
...
export const examenFinal = [
  ...
  {
    pregunta: `${tema15} How _ (many/much) apples do you eat a week?`,
    opciones: [`much`, `many`],
    respuesta: `many`,
    img: `${imgTema15}`,
  },
