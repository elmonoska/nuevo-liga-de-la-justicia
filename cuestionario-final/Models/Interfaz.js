export class Interfaz {
    ...
    muestraCalificacion(calificacion){
        if(calificacion < 80){
            ...
            <p>Podemos notar que este curso ha rendido frutos. Con esto finalizamos esta prueba y ahora <strong>solo tendras que llenar el siguiente formulario con tus datos de contacto con ayuda de tu Papá o Mamá.</strong>.</p>
            ...
            method="POST" class="border py-5 px-3 d-flex flex-column justify-content-around gap-2">
                ...
                <input class="form-control" type="tel" name="folio" required placeholder="Escribe aqui tu folio o referencia" pattern="[0-9]{7}" title="Tu numero de folio empieza con 3 o 4 y solo esta compuesto por 7 digitos">
                
                <label class="form-label">Nombre completo del titular del contrato:</label>
                <input class="form-control" type="text" name="nombreTitular" required placeholder="Escribe aqui el nombre completo" pattern="[A-Za-z ]{1,50}" title="El nombre solo debe tener letras">
                
                <label class="form-label">Nombre completo del estudiante:</label>
                <input class="form-control" type="text" name="nombreEstudiante" required placeholder="Escribe aqui tu nombre completo" pattern="[A-Za-z ]{1,50}" title="El nombre solo debe tener letras">
                
                <label class="form-label">Edad:</label>
                <input class="form-control" type="tel" name="edad" required placeholder="Escribe aqui tu edad" pattern="[0-9]{2}" title="La edad solo puede tener numeros">

                <label class="form-label">Correo electronico:</label>
                <input class="form-control" type="email" name="email" required placeholder="Escribe aqui tu correo" title="Verifica bien tu correo">
                

                <hr>
                <p class="text-center display-5 text-primary"><strong>Domicilio donde quieres recibir tu diploma</strong>.</p>
                <label class="form-label">Calle:</label>
                <input class="form-control" type="text" name="calle" required placeholder="Escribe aqui tu calle" pattern="[A-Za-z0-9 ]{1,40}">
                
                <label class="form-label">Numero de Exterior:</label>
                <input class="form-control" type="text" name="numeroExterior" required placeholder="Escribe aqui tu numero de exterior" pattern="[A-Za-z0-9 ]{1,20}">
                
                <label class="form-label">Numero de interior:</label>
                <input class="form-control" type="text" name="numeroInterior" placeholder="Escribe aqui tu numero de interior" pattern="[A-Za-z0-9 ]{1,20}">
                
                <label class="form-label">Entre calles:</label>
                <input class="form-control" type="text" name="entreCalle" required placeholder="Escribe aqui las entre calles" pattern="[A-Za-z0-9 ]{1,45}">
                
                <label class="form-label">Referencias (color y tipo de fachada):</label>
                <input class="form-control" type="text" name="referencias" required placeholder="Escribe aqui la referencia de tu domicilio" pattern="[A-Za-z0-9 ]{1,75}">
                
                <label class="form-label">Colonia:</label>
                <input class="form-control" type="text" name="colonia" required placeholder="Escribe aqui tu colonia"pattern="[A-Za-z0-9 ]{1,45}">
                
                <label class="form-label">Delegacion o Municipio:</label>
                <input class="form-control" type="text" name="delegacion" required placeholder="Escribe aqui tu delegacion o Municipio" pattern="[A-Za-z0-9 ]{1,45}">
                
                <label class="form-label">Estado:</label>
                <input class="form-control" type="text" name="estado" required placeholder="Escribe aqui tu estado" pattern="[A-Za-z ]{1,45}" title="El estado solo debe tener letras">
                
                <label class="form-label">Codigo Postal:</label>
                <input class="form-control" type="tel" name="codigoPostal" required placeholder="Escribe aqui tu codigo postal" pattern="[0-9]{5}" title="El codigo postal debe componerse de 5 numeros ">
                
                <label class="form-label">Telefono de casa:</label>
                <input class="form-control" type="tel" name="telefonoCasa" required placeholder="Escribe aqui tu telefono de casa" pattern="[0-9]{10}" title="El numero de casa debe ser a 10 digitos">
